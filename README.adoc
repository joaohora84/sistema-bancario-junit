...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/joaohora84/sistema-bancario-junit/maven[GitHub Workflow Status]
